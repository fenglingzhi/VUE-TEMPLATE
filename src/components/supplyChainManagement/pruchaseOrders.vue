<template>
    <div class="pruchase_orders">
        <div class="form">
            <a-row>
                <a-col :span="2" class="text">采购单号：</a-col>
                <a-col :span="4"><a-input  placeholder=""/></a-col>
                <a-col :span="2" class="text">CP号：</a-col>
                <a-col :span="4"><a-input  placeholder=""/></a-col>
                <a-col :span="2" class="text">SKU：</a-col>
                <a-col :span="4"><a-input  placeholder=""/></a-col>
            </a-row>
            <a-row style="margin-top: 20px;">
                <a-col :span="2" class="text">采购日期：</a-col>
                <a-col :span="4"><a-range-picker /></a-col>
                <a-col :span="2" class="text">预计收货日期：</a-col>
                <a-col :span="4"><a-range-picker /></a-col>
            </a-row>
            <a-row style="margin-top: 20px;">
                <a-col :span="2" class="text">供应商：</a-col>
                <a-col :span="4">
                    <a-select defaultValue="请选择" style="width: 100%">
                        <a-select-option value="jack">南京卡佩西服饰有限公司</a-select-option>
                    </a-select>
                </a-col>
                <a-col :span="2" class="text">申请人：</a-col>
                <a-col :span="4">
                    <a-select defaultValue="请选择" style="width: 100%">
                        <a-select-option value="jack">cupsheAdmin</a-select-option>
                    </a-select>
                </a-col>
                <a-col :span="2" class="text">状态：</a-col>
                <a-col :span="4">
                    <a-select defaultValue="请选择" style="width: 100%">
                        <a-select-option value="jack">待审核</a-select-option>
                        <a-select-option value="lucy">已审核</a-select-option>
                    </a-select>
                </a-col>
            </a-row>
            <a-row style="margin-top: 20px;">
                <a-col :span="2"><a-button type="primary">搜索</a-button></a-col>
                <a-col :span="2"><a-button type="primary">审核</a-button></a-col>
                <a-col :span="2"><a-button type="primary">导出</a-button></a-col>
            </a-row>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            Search(){
                this.$router.push('/pruchaseOrderSearch')
            },
            editor(){
                alert('编辑')
            },
        ...
        mounted() {
            this.$store.commit('update_router','采购单')
        }
    }
</script>
