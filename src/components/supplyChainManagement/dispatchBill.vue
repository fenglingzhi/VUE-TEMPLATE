    ...
    <div class="dispatch_bill">
        <div class="form">
            <a-row>
                ...
                <a-col :span="4"><a-input  placeholder=""/></a-col>
                <a-col :span="2" class="text">物流单号：</a-col>
                <a-col :span="4"><a-input  placeholder=""/></a-col>
                <a-col :span="2" class="text">发货时间：</a-col>
            ...
            <a-row style="margin-top: 20px;">
                ...
                <a-col :span="1" class="">
                    <router-link to="/dispatchBillAdd">
                        <a-button type="primary" >新建</a-button>
                    </router-link>
                </a-col>
                <a-col :span="2" class=""><a-button type="primary">确认收货</a-button></a-col>
        ...
        <div class="table" style="margin-top: 20px;">
            <a-table
                ...
                <span slot="action" slot-scope="text, record">
                  ...
                  <a @click="editor()">编辑</a>
                    <a-divider type="vertical"></a-divider>
                  <a @click="audit()" class="ant-dropdown-link">确认收货</a>
                </span>
            </a-table>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            Search(){
                this.$router.push('/dispatchBillSearch')
            },
            editor(){
                this.$router.push('/dispatchBillEdit')
            },
            audit(){
                alert('审核')
            }
        ...
        mounted() {
            this.$store.commit('update_router','发货单')
        }
    }
</script>
