    ...
    <div class="qualityControlList">
        <div class="form">
            ...
            <a-row style="margin-top: 20px;">
                ...
                <a-col :span="2" class="text">检验人：</a-col>
                <a-col :span="4">
                    <a-select defaultValue="请选择" style="width: 100%">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            Search(){
                this.$router.push('/qualityControlListSearch')
            },
            editor(){
                alert('编辑')
            },
        ...
        mounted() {
            this.$store.commit('update_router','质检单')
