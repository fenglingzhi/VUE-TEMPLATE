<template>
    <div class="qualityControlListSearch">
        <div class="basic_info">
            <a-row type="flex" justify="space-between">
                <a-col :span="2" class="title">基础信息</a-col>
                <a-col :span="2"><a-button type="primary">取消</a-button></a-col>
            </a-row>
            <a-divider />
            <a-row>
                <a-col :span="4">*质检单号：Admin</a-col>
                <a-col :span="4">申请检验日期： 2019-03-07</a-col>
                <a-col :span="4">*检验员：Admin</a-col>
                <a-col :span="4">状态：未审核</a-col>
                <a-col :span="4">检验时间：2019-03-07</a-col>
                <a-col :span="4">备注：<a href="#javascript;">下载/预览</a></a-col>
            </a-row>
        </div>
        <a-divider />
        <div class="goods">
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$store.commit('update_router','产看质检单')
        }
    }
</script>
