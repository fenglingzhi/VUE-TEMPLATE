<template>
    <div class="supplier">
        <div class="form">
            <a-row>
                <a-col :span="2" class="text">供应商ID：</a-col>
                <a-col :span="4"><a-input  placeholder=""/></a-col>
                <a-col :span="2" class="text">供应商名称：</a-col>
                <a-col :span="4"><a-input  placeholder=""/></a-col>
                <a-col :span="2" class="text">手机号：</a-col>
                <a-col :span="4"><a-input  placeholder=""/></a-col>
                <a-col :span="2" class="text">联系人：</a-col>
                <a-col :span="4"><a-range-picker /></a-col>
            </a-row>
            <a-row style="margin-top: 20px;">
                <a-col :span="2" class="text">创建者：</a-col>
                <a-col :span="4">
            ...
            <a-row style="margin-top: 20px;">
                ...
                <a-col :span="1" class="button_wrap"><a-button type="primary">导入</a-button></a-col>
            </a-row>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$store.commit('update_router','供应商')
